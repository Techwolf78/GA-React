...
function CollegeAccreditation() {
  return (
    <div className="relative p-4 md:p-8 lg:p-12 bg-gradient-to-b from-[#003073] to-[#091327] text-white roboto-regular">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
        <p 
          className="text-2xl sm:text-3xl lg:text-4xl xl:text-4xl font-bold text-[#FFC80E] mb-6 text-center"
        >
          PARTNERED COLLEGES ACCREDITATION
        </p>

        {/* Background image for medium and large screens */}
        <div className="w-full hidden md:block overflow-hidden mb-6">
          <img 
