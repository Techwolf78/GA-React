...
<div className="flex flex-col mb-8 md:mb-0 md:w-1/4">
  ...
  <ul className="space-y-4"> {/* Increased space-y for better spacing */}
    <li className="flex flex-col items-center">
      <FontAwesomeIcon icon={faMapMarkerAlt} className="text-xl text-yellow-400 mb-1" />
    ...
    <li className="flex flex-col items-center">
    <FontAwesomeIcon icon={faMobileAlt} className="text-xl text-yellow-400 mb-1" />
      <p className="text-sm text-center">
    ...
    <li className="flex flex-col items-center">
      <FontAwesomeIcon icon={faEnvelope} className="text-xl text-yellow-400 mb-1" />
      <p className="text-sm text-center">
