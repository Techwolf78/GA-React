  ...
  return (
    ...
    >
      <article className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-lg backdrop-filter backdrop-brightness-90">
        {/* Blog Image */}
        <img src="Blogs/post2A.jfif" alt="Blog" className="w-full h-auto rounded-lg mb-6 animate__animated animate__fadeIn" />

        {/* Blog Title */}
        <h1 className="text-3xl font-bold mb-4 text-gray-800 animate__animated animate__fadeInUp">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed animate__animated animate__fadeInUp">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">Adulteration of Food during Diwali:</h2>
          <img src="Blogs/post2B.jfif" alt="Understanding the Issue" className="w-full h-auto rounded-lg mb-6 animate__animated animate__fadeInUp" />
          ...
          <p className="mb-4 text-gray-800">In order to avoid such adulterations, we take measurable steps like:</p>
          ...
          <p className="mb-4 text-gray-800">In a world where adulteration appears widespread,</p>
