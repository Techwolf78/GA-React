...
import floatingImageSrc from '../../../public/MasterClass/3d.png'; // Replace with your image path
import GallerySlider from './GallerySlider'; // Assuming you have a GallerySlider component

function Home() {
  return (
    <div className="relative flex h-screen bg-[#00a59f] overflow-hidden px-4 md:px-16">
      {/* Left Side - Content */}
      ...
      {/* Floating Image
      <FloatingImage src={floatingImageSrc} alt="Floating Element" /> */}
    </div>
  );
}
