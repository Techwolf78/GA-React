  ...
  return (
    <>
      <header
        ...
        style={{
          backgroundColor: `rgba(0, 165, 159, ${navbarOpacity})`,
          color: "#ffffff",
        }}
      >
        ...
        <nav className="hidden lg:flex space-x-4">
          <a
            href="/"
            className="hover:bg-[#00BFA6] hover:text-[#1a1a1a] py-2 px-4 transition-colors duration-300"
          ...
          >
            <button
              ...
              className="hover:bg-[#00BFA6] hover:text-[#1a1a1a] py-2 px-2 flex items-center justify-center transition-colors duration-300"
            >
              ...
              <div className="absolute top-full left-0 mt-0 bg-[#ffffff] text-[#1a1a1a] shadow-lg z-50 whitespace-nowrap">
                {[
                  ...
                  <a
                    key={item}
                    href={`/${
                      item === "Industry Readiness Program"
                        ? "collegeTraining"
                        : item.replace(" ", "").toLowerCase()
                    }`}
                    className="block px-4 py-2 hover:bg-[#00BFA6] transition-colors duration-300"
                    onClick={() => {
        ...
        <div
          className={`fixed top-0 left-0 h-full bg-white bg-opacity-90 text-black z-40 overflow-x-hidden transition-all duration-300 transform ${
        ...
        >
          ...
          <a
            href="/"
            className="block py-3 pl-8 hover:bg-[#00BFA6] hover:text-[#1a1a1a] transition-colors duration-300"
            onClick={handleSidebarItemClick}
          >
          ...
          <div>
            ...
            <a
              ...
              className="block py-2 pl-12 hover:bg-[#00BFA6] hover:text-[#1a1a1a] transition-colors duration-300"
              onClick={handleSidebarItemClick}
            >
