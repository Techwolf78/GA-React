...
const PartneredUniversities = () => {
  ...
  return (
    <div className="relative p-6 bg-[#091327] text-white">
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-center mb-4 mx-auto max-w-full underline text-[#ffc700]">
        Partnered with 60+ Colleges/Universities
      </h1>
      <div className="text-center mb-6">
        <p className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-semibold text-[#ffc700] mb-4">
          PAN INDIA
        </p>
      </div>
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 md:gap-6 mb-6">
        {domains.map((domain) => (
          <div
            key={domain.name}
            className="bg-[#2e4d80] border border-gray-300 rounded-lg p-4 shadow-md text-center relative"
      ...
      <div className="text-center mb-6">
        <h3 className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-semibold text-[#ffc700] mb-4">
          Gender Distribution of Students
        </h3>
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 md:gap-8">
          <div className="flex items-center">
            <FontAwesomeIcon icon={faMale} size="4x" className="text-[#ffc700] mr-2 sm:mr-3" />
            <span className="text-base sm:text-lg md:text-2xl font-bold">55% MALE</span>
          </div>
          <div className="flex items-center">
            <FontAwesomeIcon icon={faFemale} size="4x" className="text-[#ffc700] mr-2 sm:mr-3" />
