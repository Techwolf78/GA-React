...
const PartneredUniversities = () => {
  return (
    <div className="relative p-6 bg-[#091327] text-white roboto-regular">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-center mb-4 mx-auto max-w-full text-[#FFC80E]">
