...
const DigitalMarketing = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="bg-[#FFC80E] px-4 sm:px-8 md:px-16 py-8 lg:py-12 overflow-hidden"
    >
      <div className="text-center mb-16">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-black mb-6 sm:mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 gap-y-16 px-1 justify-center">
          {[
            "Paid Ads",
            ...
            <div
              ...
              className="service-card relative w-64 h-80 bg-blue-900 p-6 flex flex-col items-center justify-center text-center cursor-pointer"
            >
