  ...
  return (
    <div className="flex flex-col lg:flex-row relative">
      ...
      <div className="flex w-full h-full">
        <div className="w-full lg:w-1/3 flex flex-col justify-center h-auto lg:h-[100vh] bg-white pl-8 md:pl-16">
        ...
        {/* Right Section */}
        <div className="w-full lg:w-2/3 pr-8 md:pr-16 pl-8 flex flex-col justify-center items-center">
