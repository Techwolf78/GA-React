        ...
        <div className="w-full md:w-2/3 flex items-center justify-end space-x-6">
          ...
          <div className="relative transition-transform transform hover:scale-105 duration-300 order-1 md:order-1">
            ...
            <img
              ...
              loading="lazy"
            />
            <div className="bg-blue-700 text-white text-center text-lg md:text-xl lg:text-xl font-semibold py-1.5 px-4 absolute bottom-0 left-1/2 transform -translate-x-1/2 -mb-3 rounded-md z-20 shadow-lg whitespace-nowrap">
