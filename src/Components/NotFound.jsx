...
const NotFound = () => {
    return (
        <div className="flex items-center justify-center h-screen bg-gradient-to-r from-indigo-500 to-blue-600 relative overflow-hidden">
            ...
            >
                ...
                <motion.a 
                    href="/" 
                    className="mt-6 inline-block px-6 py-3 text-lg font-semibold text-white bg-blue-900 rounded-lg hover:bg-blue-800 transition"
                    initial={{ y: 20 }} 
                    animate={{ y: 0 }} 
