        ...
        <div className="relative z-10">
          <div className="container mx-auto px-4 py-32">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-black fade-in-text">Welcome to Gryphon Academy</h1>
            ...
            <div className="flex justify-center items-center mt-12 space-x-4">
              ...
              <div className="card-wrapper bg-purple-200 rounded-lg p-6 flex flex-col items-center h-[260px] w-[260px] hover:bg-purple-300 transition-all duration-300 shadow-lg">
                <img src={learningAndDevelopmentImg} alt="Learning And Development" className="w-20 h-20 mb-2" />
                <p className="text-lg font-semibold text-black text-center">Learning And Development</p>
                <a href="#" className="mt-2 text-purple-600 font-bold flex items-center space-x-2 hover:text-purple-800">
                  <span>Know More</span>
              ...
              <div className="flex flex-col items-center space-y-4">
                <div className="bg-blue-200 rounded-lg h-[260px] w-[260px] flex flex-col items-center justify-center relative hover:shadow-2xl transition-shadow duration-300">
                  <img src={placementImg} alt="Placement" className="w-full h-full object-cover rounded-lg" />
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                    <h3 className="text-xl font-bold text-black mb-2">Placement</h3>
                    <a href="#" className="text-purple-200 font-bold flex items-center space-x-2 hover:text-purple-800">
                      <span>Know More</span>
                      <i className="fas fa-arrow-right"></i>
                    </a>
                  </div>
