...
const Home = () => {
  ...
  <div className="flex flex-col items-center space-y-4">
    <div className="bg-blue-200 rounded-lg h-[260px] w-[260px] flex flex-col items-center justify-center relative hover:shadow-2xl transition-shadow duration-300">
      ...
      <h3 className="text-xl font-bold text-black mb-2 text-shadow">TRAINING</h3>

        <a href="/training" className="text-purple-200 font-bold flex items-center space-x-2 hover:text-purple-800">
          <span>Know More</span>
          <i className="fas fa-arrow-right"></i>
        </a>
      </div>
