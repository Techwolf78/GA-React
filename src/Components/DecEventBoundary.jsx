  ...
  return (
    <div>
      ...
      <section className="relative w-full h-[70vh] bg-[url('/Event/h5bg.avif')] bg-cover bg-center text-white flex items-center justify-center font-poppins">
        ...
        <div className="relative text-center px-6 md:px-12 z-20" data-aos="fade-up" data-aos-duration="1500">
      ...
      <section className="py-16 px-2 md:px-6 bg-gray-100 relative h-[0vh] md:h-[20vh]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-2 md:gap-12 relative z-10 top-[-140px] md:top-[-200px]">
            {/* Card 1 */}
            <div
              className="card relative bg-[url('/Event/h1.avif')] bg-cover bg-center shadow-lg rounded-lg p-2 md:p-6 hover:shadow-2xl transition-all h-48 md:h-72 overflow-hidden flex-1"
              data-aos="fade-up"
            ...
            {/* Card 2 */}
            <div
              className="card relative bg-[url('/Event/panel1.avif')] bg-cover bg-center shadow-lg rounded-lg p-2 md:p-6 hover:shadow-2xl transition-all h-48 md:h-72 overflow-hidden flex-1"
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-delay="400"
            >
            ...
            {/* Card 3 */}
            <div
              className="card relative bg-[url('/Event/keyinda.avif')] bg-cover bg-left shadow-lg rounded-lg p-2 md:p-6 hover:shadow-2xl transition-all h-48 md:h-72 overflow-hidden flex-1"
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-delay="500"
            >
