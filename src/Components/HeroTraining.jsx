...
const HeroTraining = () => {
  ...
  return (
    <div className="bg-[#091327] relative roboto-regular">
      ...
      <div
  ref={ref}
  className="lg:flex flex-col justify-between p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 bg-cover bg-center h-[50vh] lg:h-screen"
  style={{ backgroundImage: "url('Training 1 1.png')" }}
>
     {/* Heading at the top */}
<div className="text-center md:text-left mt-20 lg:mt-28 ml-10 lg:ml-14">
  <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-5xl font-bold mb-2 text-[#000000]" style={fadeInStyle}>
 ...
 {/* Stat boxes */}
<div className="hidden lg:flex absolute top-36 right-4 p-2" style={fadeInStyle}>
...
<div className="hidden lg:flex absolute bottom-12 right-4 p-2" style={fadeInStyle}>
  <div className="relative stat-box">
    <div className="p-3 bg-[#003073] shadow-md flex items-center space-x-2 transition duration-300 hover:bg-[#002060]">
