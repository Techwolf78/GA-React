  ...
  return (
    ...
    >
      <motion.div
        ...
        exit={{ scale: 0.8 }}
        className="relative w-1/3 h-1/2 bg-transparent shadow-lg flex flex-col overflow-hidden z-10 border-2 border-yellow-400"
      >
        {/* Close button */}
        <button
          onClick={handleClose}
          title="Close"
          className="absolute top-4 right-4 w-6 h-6 rounded-full border-2 border-yellow-500 text-[#FFC80E] bg-transparent flex items-center justify-center text-xl cursor-pointer z-20 transition-all duration-300 ease-in-out hover:bg-yellow-500 hover:border-yellow-500 hover:text-black"
        >
          ×
        </button>
        ...
        <div className="relative w-full h-full bg-transparent">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center z-2 bg-black bg-opacity-60">
            ...
            <div className="w-full flex flex-col justify-center items-center z-3 text-white text-shadow-xl p-5">
              ...
              <h3 className="heading text-2xl sm:text-3xl font-bold mb-2 leading-tight text-left uppercase text-[#FFC80E] tracking-wide">
                SYNERGY SPHERE 2024
              </h3>
              ...
              {timeLeft && (
                <div className="mt-4 p-2 rounded-3xl shadow-xl flex flex-col max-w-xs mx-auto ">
                  <p className="text-xl sm:text-2xl mb-2 font-bold text-center text-[#fff]">
                    Event{" "}
                  ...
                  <div className="flex justify-center text-lg sm:text-2xl font-bold text-[#fff] tracking-wide">
                    <div className="mx-3 flex flex-col items-center">
                      ...
                      <span className="text-xs sm:text-sm text-[#fff] uppercase">
                        Days
                      </span>
                    </div>
                    <div className="mx-3 flex flex-col items-center">
              ...
              <button
                ...
                className="mt-4 py-2 px-4 text-white hover:text-black font-semibold text-sm border-2 border-[#FFC80E] transition duration-300 ease-in-out overflow-hidden relative group glow-border"
              >
                {/* Animated Fill */}
                ...
                {/* Button Text */}
                <span className="relative z-10 text-base">Know More</span>
              </button>
            </div>
          </div>
